...
export default function ImperialSectionHeader({ numeral, title, editButton }) {
  return (
    <div className="flex items-center gap-3 mb-5">
      <span className="classical-decor w-7 h-7 border-2 border-[#C8960C] bg-[#8B1A1A] text-[#C8960C] flex items-center justify-center text-[10px] font-black flex-shrink-0 relative">
        {numeral}
      ...
      <div className="classical-decor flex-1 h-px bg-gradient-to-r from-[#C8960C]/50 to-transparent" />
      {editButton}
    </div>
  );
}
